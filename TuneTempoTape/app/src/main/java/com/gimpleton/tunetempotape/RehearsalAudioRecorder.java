 ...
 * http://sourceforge.net/p/rehearsalassist/code/HEAD/tree/android/branches/transformative/src/urbanstew/RehearsalAssistant/RehearsalAudioRecorder.java
 *
 * Decided to use this instead of the standard Android Media Recorder as it records audio uncompressed and therefore
 * better quality. File size is however a lot larger.
 */
